        ...
        <div class="card-body">
          ...
          <div class="JobItemsDiv alert alert-info" role="alert">
            @if(count($job_items_records) > 0)
              <h3><span class="badge badge-secondary">{{ $job_items_records->total() }}</span><span> Saved Items, Est. Total: </span><span class="badge badge-secondary">${{ $item_grand_total }}</span> </h3>
              <hr class="my-1">
