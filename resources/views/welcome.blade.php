...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
      <div class="bg">
          <canvas id="fisr" width="467" height="624" style="width: 467px; height: 624px;">0:03:29:25</canvas>
      </div>
    </body>
    <script>
    var canvas;
    ...
    function init() {
      ...
      if (canvas.getContext) {
        ...
        window.addEventListener("resize", function () {
          resizeCanvas(); stage.globalCompositeOperation = "lighter";
        });
     ...
     function update() {
       ...
       for (i = 0; i < particles.length; i++) {
         ...
         stage.fill(); particles[i].x += particles[i].xs;
        ...
        stage.globalCompositeOperation = "darken"; stage.strokeStyle = "rgba(0,0,0,0)";
        stage.miterLimit = 4; stage.fillStyle = "#0171D0"; stage.beginPath();
        stage.moveTo(0, 100);
        ...
        stage.closePath(); stage.moveTo(25, 100);
